...
const file = 'worker/src/phase15-fingerprint.ts';
const formattedFile = '/tmp/phase15-fingerprint.formatted.ts';
...
console.log('PHASE15_FORMAT_DIFF_BEGIN');
console.log(diff.stdout || 'NO_DIFF');
console.log('PHASE15_FORMAT_DIFF_END');
